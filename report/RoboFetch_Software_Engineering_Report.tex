...
{Scenario 1: a controller places an order and it is delivered. The task manager sends a
destination, not a velocity: the navigation stack decides how to get there and drives the robot
