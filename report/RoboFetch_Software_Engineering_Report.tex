...
as one lifeline and leaves that division to the text. The web tier answers as soon as the stop has
been published, before the robot has physically halted, because an emergency control that blocks
until the brake has taken effect is worse than one that returns at once. Nothing is written by the
